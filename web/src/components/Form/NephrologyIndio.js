...
export default class Form extends Component {
      ...
      .then(
        () =>
          (document.getElementById(
            "nephrology-indio-form-ajax-response"
          ).innerHTML =
            "Thank you for contacting us! We will get in touch with you shortly."),
        form.remove(),
        (window.dataLayer = window.dataLayer || []),
        window.dataLayer.push({
          event: "nephrologyIndioFormSubmission",
        })
      )
  ...
  render() {
    return (
      <StyledForm>
        <div id="nephrology-indio-form-ajax-response"></div>
        <form
        ...
        >
          ...
          <input
            type="hidden"
            name="form-name"
            value="Coachella Valley Nephrology - Indio"
          />
          <div hidden>
            <label>
              Don’t fill this out:{" "}
