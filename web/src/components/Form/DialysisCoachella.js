...
export default class Form extends Component {
      ...
      .then(
        () =>
          (document.getElementById(
            "dialysis-coachella-form-ajax-response"
          ).innerHTML =
            "Thank you for contacting us! We will get in touch with you shortly."),
        form.remove(),
        (window.dataLayer = window.dataLayer || []),
        window.dataLayer.push({
          event: "dialysisCoachellaFormSubmission",
        })
      )
  ...
  render() {
    return (
      <StyledForm>
        <div id="dialysis-coachella-form-ajax-response"></div>
        <form
        ...
        >
          ...
          <input
            type="hidden"
            name="form-name"
            value="Coachella Kidney Institute"
          />
          <div hidden>
            <label>
              Don’t fill this out:{" "}
