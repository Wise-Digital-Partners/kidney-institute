      ...
      <section className="pt-20 md:pt-40 pb-22 md:pb-32">
        <div className="container">
          ...
          <p>
            ...
            Kidney Institute may collect personally identifiable information,
            such as your: 
          </p>
          <p>
            - First and Last Name 
          ...
          <p>
            Kidney Institute collects and uses your personal information to
            operate and deliver the services you have requested. 
          </p>
          <p>
            Kidney Institute may also use your personally identifiable
            information to inform you of other products or services available
            from Kidney Institute and its affiliates. 
          </p>
          <h3>Sharing Information with Third Parties</h3>
          <p>
            Kidney Institute does not sell, rent or lease its customer lists to
            third parties. 
          </p>
          <p>
            Kidney Institute may share data with trusted partners to help
            ...
            provide these services to Kidney Institute, and they are required to
            maintain the confidentiality of your information. 
          </p>
          <p>
            Kidney Institute may disclose your personal information, without
            ...
            comply with legal process served on Kidney Institute or the site;
            (b) protect and defend the rights or property of Kidney Institute
            and/or (c) act under exigent circumstances to protect the personal
            safety of users of Kidney Institute, or the public. 
          </p>
          <h3>Automatically Collected Information</h3>
          <p>
            Information about your computer hardware and software may be
            automatically collected by Kidney Institute This information can
            ...
            provide general statistics regarding use of the Kidney Institute
            website. 
          </p>
          <h3>Use of Cookies</h3>
          <p>
            The Kidney Institute website may use "cookies" to help you
          ...
          <p>
            ...
            you personalize Kidney Institute pages, or register with Kidney
            Institute site or services, a cookie helps Kidney Institute to
            ...
            to the same Kidney Institute website, the information you previously
            provided can be retrieved, so you can easily use the Kidney
            Institute features that you customized. 
          </p>
          <p>
            ...
            interactive features of the Kidney Institute services or websites
            you visit. 
          </p>
          <h3>Links</h3>
          <p>
          ...
          <p>
            Kidney Institute does not knowingly collect personally identifiable
          ...
          <p>
            From time to time, Kidney Institute may contact you via email for
            ...
            an email from Kidney Institute or click on a link therein. 
          </p>
          <p>
            If you would like to stop receiving marketing or promotional
            communications via email from Kidney Institute and Supply Co., you
            may opt out of such communications by clicking on the UNSUBSCRIBE
            button. 
          </p>
          <h3>Changes to this Statement</h3>
          <p>
            Kidney Institute reserves the right to change this Privacy Policy
          ...
          <p>
            Kidney Institute welcomes your questions or comments regarding this
            Statement of Privacy. If you believe that Kidney Institute has not
            adhered to this Statement, please contact Kidney Institute at: 
          </p>
          <p>Kidney Institute </p>
          <p>
            Email Address: 
            <br />
          </p>
