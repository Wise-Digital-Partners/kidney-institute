  ...
  return (
    <Layout headerHasBorder={true}>
      <SearchEngineOptimization
        ...
        description="Get top experts by your side. Our Thousand Palms dialysis clinic and nephrologists are specialists in the diagnosis and treatment of kidney disease."
      ...
      >
        <div className="max-w-2xl">
          <h1 className="text-secondary-900 md:text-white text-mobile-7xl md:text-7xl font-extrabold mb-4 md:mb-6">
            Expert Kidney Care. Serving Thousand Palms Since 1987.
          </h1>
      ...
      <section className="mb-20 md:mb-32">
        <div className="container">
          <header className="md:text-center md:max-w-[800px] md:mx-auto mb-20 md:mb-32">
            ...
            <h2>Thousand Palms Dialysis Clinic & Nephrologists</h2>
            <p>
          ...
          <div className="grid md:grid-cols-2 gap-y-6 md:gap-x-10 lg:gap-x-20 items-center mb-20 md:mb-32">
            <div className="order-2 md:order-1">
              ...
              <p>
                ...
                dialysis. Our Thousand Palms kidney specialists provide expert,
          ...
          <div className="grid md:grid-cols-2 gap-y-6 md:gap-x-10 lg:gap-x-20 items-center">
            ...
            <div>
              ...
              <p>
                ...
                here and around the world. Our Thousand Palms nephrologists are
